    ...
    class SendText
    {
        ...
        public static void Twilio(DateTime deadLine, string recipient)
        {
            ...
            var message = twilio.SendMessage(
              ...
              "Hey jerks!! It's been " + daysSinceCleaning + " days since the cat box was last cleaned! <a href=\"http://doyourchoresjb.azurewebsites.net/CatBox/Clean\">Click here if you've cleaned it!</a>",
              ""
            );
